...
/*const [firstNameOfChris: Chris, lastNameOfChris: Owen, ageOfChris: 12] =
  personChris;
console.log(personChris);*/
const [ageOfChris, firstNameOfChris, lastNameOfChris] = personChris;
console.log(firstNameOfChris, ageOfChris, lastNameOfChris);
...
const [name1, name2, lastName] = students;
